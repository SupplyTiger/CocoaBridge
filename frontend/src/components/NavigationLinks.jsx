import {Home, Mail, BrainCog, Calendar, BarChart, TrendingUp, Contact, Lock, Award, Handshake, Star, MessageSquare} from "lucide-react";
...
export const NAVIGATION_LINKS = [
    ...
    { name: "Metrics", path: "/metrics", icon: <TrendingUp className="size-5"/> },
