...
import {Home, Mail, BrainCog, Calendar, ChartBarIncreasing, Contact, Lock, PanelLeftIcon} from "lucide-react";
...
<div className="navbar w-full bg-base-300">
    ...
    <div className="flex-1 px-4">
        <h1 className="text-xl font-bold">{NAVIGATION_LINKS.find((item => item.path === location.pathname))?.name || "Dashboard"}</h1>
        </div>
